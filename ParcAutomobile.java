...
public class ParcAutomobile {
    ...
    private static List<Vehicule> tousLesVehicules = new ArrayList<>();
        ...
        do {
            ...
            switch (choix) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    afficherVehiculesLouesOuDisponibles(DISPONIBLE);
                    break;
                case 7:
                    afficherVehiculesLouesOuDisponibles(LOUE);
                    break;
                case 8:
                    afficherTousLesVehicules();
                    break;
                case 9:
                    afficherLocationsClient();
                    break;
                default:
                    System.out.println("\nFin du programme...");
                    continuer = false;
    ...
    public static void ajouterClient() {
        ...
        new Client(nom, prenom, permisdeconduire, numero);
    }

    public static void afficherClients() {
        for (Client client : Client.getListeDeClients()) {
            System.out.println("\n" + client.toString());
        }
    }
    ...
    public static void louerVehicule() {
        ...
        while (i < Client.getNombreClients() && i < numClient) {
            i++;
        }
        if (i == numClient) {
            client = Client.getListeDeClients().get(i-1);
            i = 0;
            afficherTousLesVehicules();
